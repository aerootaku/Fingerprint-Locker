...
from databaseHelper import connect
...
try:
    ...
    print("Saving Fingerprint Image for database (This may take a while)")
    imageDestination =  '/home/pi/Desktop/fingerprint/fingerprint.bmp'
