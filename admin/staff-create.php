...
if(isset($_POST['register'])){
    if(isExists('tbl_users', $where = array("username"=>$_POST['username'])) == 1){
        ...
        $create = db_insert('tbl_users', $data = array("username"=>$_POST['username'], "password"=>password_hash("Welcome123", PASSWORD_DEFAULT),
            "firstname"=>$_POST['firstname'], "lastname"=>$_POST['lastname'], "email"=>$_POST['email'], "gender"=>$_POST['gender'], "contact_no"=>$_POST['contact'],
                            ...
                            <div class="card my-3 no-b">
                                <div class="card-body">
                                    ...
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary btn-block" name="register">Save User Info</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
