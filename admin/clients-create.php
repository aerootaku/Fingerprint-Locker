...
if(isset($_POST['register'])){
    if(isExists('tbl_client', $where = array("email"=>$_POST['email']))== 1){
                    ...
                    <div class="row my-3">
                        <div class="col-md-7  offset-md-2">
                                ...
                                <div class="card no-b  no-r">
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-8">
                                                <div class="form-row">
                                                    <form action="" method="POST">
                                                        <a href="" data-target="#scanFingerprint" data-toggle="modal" name="fscan" class="btn btn-primary" id="fscan">Scan Fingerprint</a>
                                                    </form>
                                                </div>
                                                <br />
                                                <form action="" method="POST">
                                                    ...
                                                    <div id="refreshs">
                                                        <div class="form-group">
                                                            <?php
                                                        $value = custom_query("SELECT * FROM tbl_fp ORDER by id DESC LIMIT 1");
                                                        if($value->rowCount()>0)
                                                        {
                                                        ...
                                                        $id = $row['id'];
                                                        ?>
                                                        <input type="hidden" value="<?= $row['fp_template']; ?>" class="form-control" readonly name="fp_template">
                                                        <?php }} ?>
                                                        </div> 
                                                    </div>
                                                <div class="form-row">
                                                    <div class="form-group col-6 m-0">
                                                        <label for="name" class="col-form-label s-12">EMPLOYEE FIRST NAME</label>
                                                        <input id="name" placeholder="Enter First Name" class="form-control r-0 light s-12 " type="text" name="firstname" required>
                                                    </div>
                                                    <div class="form-group col-6 m-0">
                                                        <label for="name" class="col-form-label s-12">EMPLOYEE LAST NAME</label>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-6 m-0">
                                                        ...
                                                        <input id="email" placeholder="user@email.com" class="form-control r-0 light s-12 " type="text" name="email" required>
                                                    </div>
                                                    <div class="form-group col-6 m-0">
                                            ...
                                            <div class="col-md-3 offset-md-1">
                                                <label class="col-form-label s-12">PIN NO.</label>
                                                <textarea class="form-control" name="pin" rows="5" required placeholder=""><?php echo rand_string(8); ?></textarea>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-12 m-0">
                                                ...
                                                <textarea rows="5" class="form-control r-0 light s-12" id="address"
                                    ...
                                    <hr>
                                    <div class="card-body">
                                        <h5 class="card-title">Available Locker</h5>
                                        <div class="form-row">
                                            <div class="form-group col-5 m-0">
                                                <label class="my-1 mr-2" for="inlineFormCustomSelectPref">Select A Locker</label>
                                                <select class="custom-select my-1 mr-sm-2 form-control r-0 light s-12" id="inlineFormCustomSelectPref" name="locker">
                                                    <option selected>-- CHOOSE --</option>
                                                    <?php
                                                    $value = custom_query("SELECT * FROM tbl_locker WHERE status='Active' ORDER by id DESC");
                                                    if($value->rowCount()>0)
                                                    {
                                                    while($row=$value->fetch(PDO::FETCH_ASSOC))
                                                    {
                                                    $id = $row['id'];
                                                    ?>
                                                        <option value="<?= $row['locker_no']; ?>"><?= $row['locker_no']; ?></option>
                                                    <?php }} ?>
                                                </select>
                                            </div>
                                        </div>
